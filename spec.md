...
```
   ...
   - **Push-to-remote (Spark):** GUI smoke must pass before any `git push` of the change set. Do not push after NumPy-only pytest or with `SPARK_RUN_ISAAC_GUI_SMOKE=0` as a substitute. See [STATUS.md](STATUS.md) § Push-to-remote gate.
